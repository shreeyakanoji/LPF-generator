...
This file has ZERO dependency on any other file in repo (no `lfpgen`
package folder needed).This .py file into, repo root next to
...
...and point Streamlit Cloud at this file. 
